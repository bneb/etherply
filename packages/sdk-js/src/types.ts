 ...
 */
export interface EtherPlyConfig {
    /**
 ...
 */
export type EtherPlyMessage = InitMessage | OperationMessage | PresenceMessage;

/**
 * Handler function for incoming messages.
 */
export type MessageHandler = (message: EtherPlyMessage) => void;
 ...
 */
export interface ResolvedConfig extends Required<EtherPlyConfig> { }

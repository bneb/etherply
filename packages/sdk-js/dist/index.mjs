...
var AuthenticationError = class extends EtherPlyError {
...
var QueueOverflowError = class extends EtherPlyError {
  constructor(maxSize) {
    super(
...
export { AuthenticationError, ConfigurationError, ConnectionError, EtherPlyClient, EtherPlyError, MessageError, QueueOverflowError, parseMessage, truncate };
